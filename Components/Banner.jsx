    ...
    return (
        <div>
            ...
            <div className='md:w-2/4 text-center md:text-start'>
                <h1 className='xl:text-6xl lg:text-4xl text-2xl md:text-3xl   font-bold text-black'>Discover, Explore, and Download Top-Rated Apps Tailored to Your Needs — All in One Seamless Platform</h1>
